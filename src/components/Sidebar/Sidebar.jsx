            ...
            <div className="flex flex-col items-center py-4 flex-shrink-0 w-20 bg-cyan-500 rounded-3xl">
                ...
                <ul className="flex flex-col space-y-2 mt-12">
                    ...
                    <li>
                        <div
                            ...
                            <span className={`flex items-center justify-center h-12 w-12 rounded-2xl 
                                ${activeMenu !== 'report' ? 'hover:bg-cyan-400 text-cyan-100' : 'bg-cyan-300 shadow-lg text-white'}`}>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-6 w-6"
                                    fill="none"
                    ...
                    <li>
                        <div >
                            <span className={`flex items-center justify-center h-12 w-12 rounded-2xl 
                                ${activeMenu !== 'products' ? 'hover:bg-cyan-400 text-cyan-100' : 'bg-cyan-300 shadow-lg text-white'}`}>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-6 w-6"
                                    fill="none"
                    ...
                    <li>
                        <div>
                            <span className={`flex items-center justify-center h-12 w-12 rounded-2xl 
                                ${activeMenu !== 'settings' ? 'hover:bg-cyan-400 text-cyan-100' : 'bg-cyan-300 shadow-lg text-white'}`}>
                                <svg
                                    className="w-6 h-6"
                                    fill="none"
                                    stroke="currentColor"
